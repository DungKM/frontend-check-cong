...
export const CATALOG_CONFIGS = {
  ...
  service: {
    ...
    columns: [
      ...
      { key: 'tenDvktGia', header: 'Tên DVKT giá' },
      { key: 'phanLoaiPTTT', header: 'Phân loại PTTT' },
      { key: 'donGia', header: 'Đơn giá', render: (row) => formatCurrency(row.donGia) },
      { key: 'ghiChu', header: 'Ghi chú' },
      { key: 'quyetDinh', header: 'Quyết định' },
      ...
      { key: 'maCSKCB', header: 'Mã CSKCB' },
      { key: 'cskcbCgkt', header: 'CSKCB CGKT' },
      { key: 'cskcbCls', header: 'CSKCB CLS' },
    ],
    fields: [
